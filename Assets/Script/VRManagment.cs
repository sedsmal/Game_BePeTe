...
public class VRManagment : SingletonComponent<VRManagment>, ISaveable
{
    ...
    private void Awake()
    {
        ...
        Debug.Log("PPPPPcxxxxx" + countOfPlay);
    }
    ...
    public bool LoadSave()
    {
        ...
        countOfPlay = Convert.ToInt32(json["countOfPlay"].Value);
        lastTimeOfPlay = Convert.ToInt32(json["lastTimeOfPlay"].Value);
        bestTimeOfPlay = Convert.ToInt32(json["bestTimeOfPlay"].Value);
        totalTimeOfPlay = Convert.ToInt32(json["totalTimeOfPlay"].Value);
        countOfTouch = Convert.ToInt32(json["countOfTouch"].Value);
        countOfCorrectTouch = Convert.ToInt32(json["countOfCorrectTouch"].Value);
